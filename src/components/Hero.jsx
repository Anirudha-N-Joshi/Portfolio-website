...
const Hero = () => {
  ...
  const typedItems = ["Full Stack Developer", "Designer", "Learner", "Engineer"];
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915EFF]">Anirudha Joshi</span>
          </h1> <br />
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            ...
            <br /> 
            <b>I thrive on challenges and chase continuous learning.</b>
          </p>
        </div>
      </div>
      <br /><br /><br />
